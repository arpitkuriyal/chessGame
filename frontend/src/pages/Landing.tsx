      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 w-full">
        ...
        <div className="text-center lg:text-left w-full lg:w-1/2">
          ...
          <button
            ...
            className="bg-green-700 rounded-md text-xl md:text-3xl lg:text-5xl flex items-center justify-center px-4 py-3 mx-auto lg:mx-0 text-white font-semibold gap-3"
          >
